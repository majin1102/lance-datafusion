...
//!
//! - [`LanceLegacySchemaProvider`]: a legacy schema provider that can eagerly
//!   populate and cache table providers in memory. Kept mainly for
//!   backwards-compatibility and ad-hoc use.
//!
...
// ---------------------------------------------------------------------------
// Legacy cached LanceSchemaProvider
// ---------------------------------------------------------------------------

/// Represents a DataFusion [`SchemaProvider`] for a single Lance namespace.
#[derive(Debug)]
pub struct LanceLegacySchemaProvider {
...
impl LanceLegacySchemaProvider {
    ...
    /// Construct a provider for the root namespace without eagerly
    /// populating any tables. This is primarily for backwards
    /// compatibility; new code should prefer [`LanceSchemaProvider`]
    /// or the async constructors above.
...
#[async_trait]
impl SchemaProvider for LanceLegacySchemaProvider {
